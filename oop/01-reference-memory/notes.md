...
* [ ] `int x`와 `int& x`의 차이를 설명할 수 있다.
* [ ] Reference가 왜 변수의 "별명"인지 설명할 수 있다.
* [ ] Pass by Value와 Pass by Reference를 구분할 수 있다.
* [ ] 함수에서 Reference를 사용하면 원본이 변경되는 이유를 설명할 수 있다.
* [ ] Pointer와 Reference의 기본적인 차이를 설명할 수 있다.
* [ ] `int&`와 `const int&`의 차이를 설명할 수 있다.
* [ ] 함수 인자에서 `const T&`를 사용하는 이유를 설명할 수 있다.
* [ ] `new/delete`와 `new[]/delete[]`의 짝을 구분할 수 있다.
* [ ] `new`와 `malloc`의 기본적인 차이를 설명할 수 있다.
* [ ] 생성자와 소멸자의 호출 시점을 설명할 수 있다.
* [ ] 초기화 리스트가 무엇인지 설명할 수 있다.
